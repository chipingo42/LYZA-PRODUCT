      ...
      <motion.div onViewportEnter={() => setSelectedPage(SelectedPage.AboutUs)} className="mx-auto justify-between w-5/6 gap-16 md:flex">
        <div className="mt-10 basis-1/3">
          ...
          <form className="mt-[48px] relative">
            <label htmlFor="email">
              <input name="email" type="email" placeholder="Enter your email address" className=" relative top-0 left-0 px-4 py-4 bg-inherit border border-solid border-primary-20 rounded-full w-full font-Recursive font-semibold text-[15px] max-sm:text-[13px] "  />
            </label>
            <button className="absolute right-2 mt-[7px] px-5 py-2 max-xs:px-3 max-xs:mt-[4px] font-Recursive font-semibold text-xs bg-primary-20 rounded-full text-primary-100 hover:bg-secondary-600 hover:text-primary-20 transition duration-500">Join now</button>
          </form>
        </div>
